...
tratamiento_lifestyle_hombres = df[(df['Treatment'] == 'Medication') & (df['Gender'] == 'Female')]
cantidad_hombres_lifestyle = len(tratamiento_lifestyle_hombres)

print(f"La cantidad de mujeres que han recibido el tratamiento 'Medication' es: {cantidad_hombres_lifestyle}")